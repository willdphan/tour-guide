...
export default function Component() {
  return (
    <div className="flex max-h-screen min-h-screen flex-col items-center bg-[#FDF9ED] ">
      <div className="w-full max-w-6xl bg-[#FDF9ED] px-6 lg:px-8">
        <header className="flex items-center justify-between px-10 py-6">
          <div className="flex items-center space-x-2">
            ...
            >
              <g>
                <rect x="6" y="5" width="8" height="16" rx="4" fill="#26433F" />
                <rect
                  x="20"
                  y="5"
                  width="8"
          ...
          <div className="flex items-center space-x-4">
            <Link
              href="#"
              className="hidden text-sm font-[500] text-[#9D6A39] lg:inline-block"
            >
              Log in
            </Link>
            <Link
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-16">
              ...
              <div className="mb-8 space-y-0 lg:mb-0 lg:w-1/2">
                ...
                <div className="flex items-center space-x-2 ">
                  ...
                  <span className="text-sm text-[#9D6A39]">
                    Over 12.5K Imaginary Ratings
                  </span>
                </div>
                <h1 className="font-serif pb-8 pt-4  font-Marcellus text-8xl leading-none lg:mr-16 lg:text-8xl xl:text-9xl">
                  Navi
                </h1>
                <blockquote className="text-md border-t-[1px] border-black pt-4 font-medium lg:mr-16">
                  <div className="flex items-center justify-between pb-5">
                    <div className="flex items-center space-x-2">
                      ...
                      >
                        <span className="text-xs text-[#9D6A39]">
                          @willdphan
                        </span>
                      </Link>
                    </div>
                    <Link
                      href="#"
                      className="flex items-center text-xs text-[#9D6A39]"
                    >
                ...
                <div className="flex items-center space-x-4 border-b-[1px] border-black pb-4 pt-4 text-xs  lg:mr-16">
                  <div className="relative h-7 w-7">
                    <div className="flex h-full w-full items-center justify-center overflow-hidden rounded-full bg-[#26433F]">
                      <svg
                        width="32"
                        height="32"
                        viewBox="0 0 32 32"
                  ...
                  <div>
                    <p className="font-Marcellus text-sm font-bold">Navi</p>
                    <p className="text-xs font-[500] text-[#9D6A39]">
                      AI Tourguide
                    </p>
                  </div>
                </div>
                <div className="flex space-x-4 pt-12">
                  ...
                  <Link
                    href="#"
                    className="rounded-full border border-black px-6 py-3 text-sm font-medium hover:border-white hover:bg-[#26433F] hover:text-white"
                  >
                    Our Story
                  </Link>
                </div>
              ...
              <div className="mt-12 lg:mt-0 lg:w-1/2 ">
                <div className="relative mx-auto aspect-square max-w-lg ">
                  ...
                  >
                    <source
                      src="https://pub-33c643825c664d0091b84d7ae37a5150.r2.dev/tour-hero.mp4"
                      type="video/mp4"
                    />
                    Your browser does not support the video tag.
                  </video>
                  <div className="absolute inset-0 bg-black opacity-0"></div>
                  <div className="left-34 absolute inset-x-0 bottom-5 flex justify-center md:bottom-10 md:left-44 lg:bottom-6 lg:left-44 xl:bottom-4 xl:left-48">
                    <PopUpDefault
                      action={{}}
                      onConfirm={() => {}}
        ...
        <footer className="w-full bg-[#FDF9ED]">
          <div className="py-0 pb-10 pt-8 lg:pb-0">
            <div className="mx-auto max-h-screen max-w-full px-4 md:px-8">
              <div className="">
                <div className="flex h-8 items-center justify-center ">
                  <div className="pb-4 text-center text-sm text-[#9D6A39] opacity-50">
                    Imaginary Clients
                  </div>
                </div>
                <ul className="flex flex-wrap items-center justify-between md:justify-around">
                  {/* LOGO 1 */}
                  <li className="mb-4 flex w-1/2 justify-center md:mb-0 md:w-auto">
                    <svg
                      className="w-28"
                      viewBox="0 0 163 48"
                      fill="none"
              ...
              {/* Product Carousel */}
              <div className="my-24 max-h-screen w-full overflow-x-auto bg-[#FDF9ED]">
                <div className="flex h-[calc(100vh-230px)] space-x-4 sm:h-[calc(100vh-220px)] sm:space-x-6 lg:h-[calc(100vh-180px)]">
                  {stages.map((stage) => (
                    <Link key={stage.id} href={stage.link}>
                      <div className="relative h-full w-64 flex-shrink-0 sm:w-80 lg:w-96 xl:w-[28rem]">
                        <div
                          className="flex h-full w-full flex-col items-center justify-center border-[1px] p-8 "
                          style={{
                        ...
                        >
                          ...
                          <h3
                            className="mb-4 font-Marcellus text-3xl font-semibold"
