...
export function Hero() {
  ...
  return (
    <div className='w-fit items-center gap-2 min-w-screen flex flex-col mt-[30px] z-[99] '>
      <h1 className='font-man text-6xl text-white ml-10 leading-tight tracking-normal'>
        There's a <span className="text-[#B6CDEB]">{percentage}%</span> Chance <br/>It'll Play Out, <Link href="/flowchart" className="text-[#B6CDEB] underline decoration-4  underline-offset-8">Prolly</Link>.
        <br />
