        ...
        case "Click":
          if (action.element_description) {
            ...
            const elementAtPoint = getElementFromPoint(
              action.screen_location.x,
              action.screen_location.y
            );
            if (elementAtPoint instanceof HTMLElement) {
              ...
              console.log(
                "No clickable element found at the specified location or with the given description"
              );
            }
          }
          break;
        ...
        case "Scroll":
          if (action.screen_location) {
            ...
            if (element) {
              ...
              console.log(
                "No element found at the specified location for scrolling"
              );
            }
          }
          break;
